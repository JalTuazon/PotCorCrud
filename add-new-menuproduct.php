...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO `restaurant menuproducts`(`MenuID`, `ProductID`) VALUES ('$menu_id', '$product_id')";

    $result = mysqli_query($conn, $sql);

    if ($result) {
        header("Location: index.php?msg=New menu product record created successfully");
    } else {
...
<body>
    ...
    <div class="container">
        <div class="text-center mb-4">
            ...
            <p class="text-muted">Select a menu and product to associate</p>
        </div>
